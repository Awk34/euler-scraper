...
The 6K text file, <a href="project/resources/p096_sudoku.txt">sudoku.txt</a>, contains fifty different Su Doku puzzles ranging in difficulty, but all with unique solutions (the first puzzle in the file is the example above).
